...
mixin _$AddCommuteEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AddCommutePickupBloc pickupBloc,
            AddCommuteLandingBloc landingBloc, AddRoundTripCubit roundTripCubit)
        addCommute,
  }) =>
...
class __$$AddCommuteImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$AddCommuteImpl(
      ...
      roundTripCubit: null == roundTripCubit
          ? _value.roundTripCubit
          : roundTripCubit // ignore: cast_nullable_to_non_nullable
              as AddRoundTripCubit,
    ));
  }
}
...
class _$AddCommuteImpl implements AddCommute {
  const _$AddCommuteImpl(
      {required this.pickupBloc,
      required this.landingBloc,
      required this.roundTripCubit});
  ...
  @override
  final AddRoundTripCubit roundTripCubit;

  @override
  String toString() {
    return 'AddCommuteEvent.addCommute(pickupBloc: $pickupBloc, landingBloc: $landingBloc, roundTripCubit: $roundTripCubit)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.roundTripCubit, roundTripCubit) ||
                other.roundTripCubit == roundTripCubit));
  }

  @override
  int get hashCode =>
      Object.hash(runtimeType, pickupBloc, landingBloc, roundTripCubit);
  ...
  TResult when<TResult extends Object?>({
    ...
    return addCommute(pickupBloc, landingBloc, roundTripCubit);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return addCommute?.call(pickupBloc, landingBloc, roundTripCubit);
  }
...
abstract class AddCommute implements AddCommuteEvent {
  const factory AddCommute(
      ...
      required final AddCommuteLandingBloc landingBloc,
      required final AddRoundTripCubit roundTripCubit}) = _$AddCommuteImpl;

  AddCommutePickupBloc get pickupBloc;
  AddCommuteLandingBloc get landingBloc;
  AddRoundTripCubit get roundTripCubit;
  @JsonKey(ignore: true)
  _$$AddCommuteImplCopyWith<_$AddCommuteImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
