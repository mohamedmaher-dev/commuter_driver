...
import 'package:commuter_driver/modules/commutes/add_commute/views/widgets/add_round_trip_view.dart';
import 'package:commuter_driver/modules/commutes/add_commute/views/widgets/location_view.dart';
import 'package:commuter_driver/modules/commutes/add_commute/views/widgets/range_view.dart';
import 'package:commuter_driver/modules/commutes/add_commute/views/widgets/time_window_view.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => di<AddRoundTripCubit>(),
        ),
      ],
...
class _AddCommuteView extends StatefulWidget {
  const _AddCommuteView();

  @override
  State<_AddCommuteView> createState() => _AddCommuteViewState();
}

class _AddCommuteViewState extends State<_AddCommuteView> {
  @override
  Widget build(BuildContext context) {
    ...
    final addRoundTripCubit = BlocProvider.of<AddRoundTripCubit>(context);
    ...
    return BlocListener<AddCommuteBloc, AddCommuteState>(
      ...
      child: Scaffold(
        appBar: AppBar(title: Text(language.add_commute)),
        body: Column(
          children: [
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  CheckboxListTile(
                    ...
                    value: addRoundTripCubit.isRoundTrip,
                    onChanged: (value) async {
                      await showModalBottomSheet(
                        context: context,
                        builder: (context) =>
                            AddRoundTripView(cubit: addRoundTripCubit),
                      );
                      setState(() {});
                    },
                  ),
                ...
                onPressed: () {
                  addCommuteBloc.add(
                    AddCommuteEvent.addCommute(
                      ...
                      roundTripCubit: addRoundTripCubit,
                    ),
                  );
                },
